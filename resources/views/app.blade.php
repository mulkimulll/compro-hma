...
<body class="index-seven hr">
    ...
    <div id="side-bar" class="side-bar">
        ...
        <div class="rts-sidebar-menu-desktop">
            <a class="logo-1" href="#"><img class="logo" src="{{ asset('assets/images/logo/logo.png') }}"
                    alt="finbiz_logo" /></a>
            <a class="logo-2" href="#"><img class="logo" src="{{ asset('assets/images/logo/logo.png') }}"
                    alt="finbiz_logo" /></a>
            <a class="logo-3" href="#"><img class="logo" src="{{ asset('assets/images/logo/logo.png') }}"
                    alt="finbiz_logo" /></a>
            <a class="logo-4" href="#"><img class="logo" src="{{ asset('assets/images/logo/logo.png') }}"
                    alt="finbiz_logo" /></a>
                ...
                <nav class="nav-main mainmenu-nav">
                    <ul class="mainmenu">
                            ...
                            <ul class="submenu">
                                <li>
                                    <ul>
                                        ...
                                        <li class="mobile-menu-link">
                                            <a href="index-six.html">Finance Home</a>
                                        </li>
                                        <li class="mobile-menu-link">
                                ...
                                <li>
                                    <ul>
                                        ...
                                        <li class="mobile-menu-link">
                                            <a href="onepage-six.html">Finance Home Onepage</a>
                                        </li>
                                        <li class="mobile-menu-link">
                                            <a href="onepage-seven.html">Human Resources Onepage</a>
                                        </li>
                                        <li class="mobile-menu-link">
                                            <a href="onepage-eight.html">IT Solutions Onepage</a>
                                        </li>
                                        <li class="mobile-menu-link">
                                            <a href="onepage-nine.html">Modern Agency</a>
                                        </li>
                        ...
                        <li class="menu-item menu-item">
                            <a class="menu-link" href="contactus.html">Contact</a>
                        </li>
                    </ul>
                </nav>
